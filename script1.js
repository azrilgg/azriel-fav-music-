...
let songs = [
    ...
    },
    {
        ...
        lyrics: [
  { time: 0, text: "You know I want you" },
  { time: 6, text: "It's not a secret I try to hide" },
  { time: 13, text: "You know you want me" },
  { time: 18, text: "So don't keep sayin' our hands are tied" },
  { time: 25, text: "You claim it's not in the cards" },
  { time: 31, text: "And fate is pullin' you miles away and out of reach from me" },
  { time: 38, text: "But you're here in my heart" },
  { time: 42, text: "So who can stop me if I decide that you're my destiny?" },
  { time: 49, text: "What if we rewrite the stars?" },
  { time: 54, text: "Say you were made to be mine" },
  { time: 59, text: "Nothin' could keep us apart" },
  { time: 64, text: "You'd be the one I was meant to find" },
  { time: 70, text: "It's up to you and it's up to me" },
  { time: 75, text: "No one can say what we get to be" },
  { time: 80, text: "So why don't we rewrite the stars?" },
  { time: 86, text: "Maybe the world could be ours tonight" },
  { time: 94, text: "Ah-oh (No, no, no, no)" },
  { time: 98, text: "Ah-oh (Mm)" },
  { time: 101, text: "You think it's easy" },
  { time: 106, text: "You think I don't wanna run to you, yeah" },
  { time: 111, text: "But there are mountains (There are mountains)" },
  { time: 116, text: "And there are doors that we can't walk through" },
  { time: 121, text: "I know you're wonderin' why" },
  { time: 126, text: "Because we're able to be just you and me within these walls" },
  { time: 133, text: "But when we go outside" },
  { time: 137, text: "You're gonna wake up and see that it was hopeless after all" },
  { time: 144, text: "No one can rewrite the stars" },
  { time: 149, text: "How can you say you'll be mine?" },
  { time: 154, text: "Everything keeps us apart" },
  { time: 159, text: "And I'm not the one you were meant to find" },
  { time: 165, text: "It's not up to you, it's not up to me" },
  { time: 170, text: "When everyone tells us what we can be" },
  { time: 175, text: "And how can we rewrite the stars?" },
  { time: 180, text: "Say that the world can be ours tonight" },
  { time: 186, text: "All I want is to fly with you" },
  { time: 191, text: "All I want is to fall with you" },
  { time: 196, text: "So just give me all of you" },
  { time: 201, text: "It feels impossible" },
  { time: 204, text: "It's not impossible" },
  { time: 207, text: "Is it impossible?" },
  { time: 210, text: "Say that it's possible" },
  { time: 214, text: "How do we rewrite the stars?" },
  { time: 219, text: "Say you were made to be mine" },
  { time: 224, text: "And nothin' could keep us apart" },
  { time: 229, text: "'Cause you are the one I was meant to find" },
  { time: 235, text: "It's up to you and it's up to me" },
  { time: 240, text: "No one could say what we get to be" },
  { time: 245, text: "And why don't we rewrite the stars?" },
  { time: 250, text: "Changin' the world to be ours" },
  { time: 256, text: "Ah-oh (No, no, no, no)" },
  { time: 260, text: "Ah-oh (Mm)" },
  { time: 263, text: "You know I want you" },
  { time: 268, text: "It's not a secret I try to hide" },
  { time: 273, text: "But I can't have you" },
  { time: 278, text: "We're bound to break and my hands are tied" }
