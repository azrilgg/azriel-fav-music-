...
let songs = [
  ...
  { time: 249, text: "Never getting older" }
   ...
   { time: 335, text: "I will go, go, go" } // outro
    ...
    lyrics: [
        { time: 0, text: "It's not good enough for me" },
        { time: 4, text: "Since I've been with you, ooh" },
        { time: 8, text: "It's not gonna work for you" },
        { time: 12, text: "Nobody can equal me (I know)" },
        { time: 16, text: "I'm gonna sip on this drink, when I'm fucked up" },
        { time: 21, text: "I should know how to pick up" },
        { time: 25, text: "I'm gonna catch the rhythm" },
        { time: 28, text: "While she push up against me, ooh, and she tipsy" },
        { time: 34, text: "I had enough convo for 24" },
        { time: 38, text: "I peep'd you from across the room" },
        { time: 42, text: "Pretty little body dancin' like GoGo, hey" },
        { time: 47, text: "And you are unforgettable" },
        { time: 51, text: "I need to get you alone (ooh)" },
        { time: 56, text: "Why not? A fuckin' good time never hurt nobody" },
        { time: 62, text: "I got a little drink, but it's not Bacardi" },
        { time: 66, text: "If you loved the girl, then I'm so, so sorry" },
        { time: 70, text: "I gotta give it to her like we in a marriage" },
        { time: 75, text: "Oh, like we in a hurry" },
        { time: 79, text: "No, no, I won't tell nobody" },
        { time: 83, text: "You're on your level too" },
        { time: 87, text: "Tryna do what lovers do" },

        { time: 92, text: "Feelin' like I'm fresh out, Boosie (Boosie)" },
        { time: 96, text: "If they want the drama, got the Uzi (Uzi)" },
        { time: 100, text: "Ship the whole crew to the cruise ship (cruise)" },
        { time: 104, text: "Doin' shit you don't even see in movies (movies)" },
        { time: 109, text: "Ride with me, ride with me, boss (boss)" },
        { time: 113, text: "I got a hard head, but her ass soft (soft)" },
